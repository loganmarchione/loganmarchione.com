---
title: "My favorite video games (and the moments I actually remember)"
date: "2026-09-10"
...
categories: 
  ...
  - "gaming"
cover:
    image: "/assets/featured/featured_controller.svg"
    alt: "featured image"
    relative: false
---
...
{{< figure src="pokemon_red.jpg" loading="lazy" alt="Pokémon Red box art" attr="Image from Wikipedia" attrlink="https://en.wikipedia.org/wiki/Pok%C3%A9mon_Red,_Blue,_and_Yellow">}}
...
{{< figure src="tloz_oot.jpg" loading="lazy" alt="The Legend of Zelda: Ocarina of Time box art" attr="Image from Wikipedia" attrlink="https://en.wikipedia.org/wiki/The_Legend_of_Zelda:_Ocarina_of_Time">}}
...
If you haven't, I highly recommend watching [this video](https://www.youtube.com/watch?v=GyUcwsjyd8Q) by YouTuber Good Blood about OOT (I find myself watching it every couple of years for nostalgia's sake).
...
{{< figure src="halo_ce.jpg" loading="lazy" alt="Halo: Combat Evolved box art" attr="Image from Wikipedia" attrlink="https://en.wikipedia.org/wiki/Halo:_Combat_Evolved">}}
...
{{< figure src="re_remake.jpg" loading="lazy" alt="Resident Evil box art" attr="Image from Wikipedia" attrlink="https://en.wikipedia.org/wiki/Resident_Evil_(2002_video_game)">}}
...
{{< figure src="me2.png" loading="lazy" alt="Mass Effect 2 box art" attr="Image from Wikipedia" attrlink="https://en.wikipedia.org/wiki/Mass_Effect_2">}}
...
{{< figure src="es_skyrim.png" loading="lazy" alt="Skyrim box art" attr="Image from Wikipedia" attrlink="https://en.wikipedia.org/wiki/The_Elder_Scrolls_V:_Skyrim">}}

For the longest time, I never understood fantasy games (i.e., magic, talking cats, etc...), but I now own at least six copies of Skyrim (who doesn't). What I couldn't understand until I played it is that Skyrim isn't a story, it's a place. I've finished the main quest once. The rest of those hundreds of hours were spent walking toward one mountain, seeing something on a different mountain, and never arriving at either.
...
These are games that I like a lot, but not quite enough to call favorites.
